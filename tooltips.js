...
const TOOLTIPS = {
  ...
  OUST: { kind: "ticker", name: "Ouster", cap: "~$1.71B", bull_2027: "$2.05B", bull_2027_pct: "+20%", bull_2028: "$2.22B", bull_2028_pct: "+30%", price: "$26.80", bull_2027_px: "$32", bull_2028_px: "$35", stance: "bull", conv: "low", thesis: "DOWNGRADED 2026-05-13 medium→low on Hesai competitive gap. Q1 2026 revenue +49% YoY ($48.6M); Stereolabs pivot to Physical AI. But Hesai (China) shipped 1M+ units 2025 (4M capacity 2026) at +9.73% op margin vs OUST -61%; Luminar filed Chapter 11; Tesla Optimus = camera-only. Bull case requires US tariffs vs Hesai OR humanoid design win.", as_of: "2026-05-13" },
