...
## Recent developments
- **2026-06-01 — NVDA RTX Spark Computex announcement = AMD PC-segment headwind; AMD closed -3%+** (per [[2026-06-01-nvda-rtx-spark-computex-keynote]]). NVIDIA's first PC superchip (Arm-based Grace + Blackwell RTX GPU + 128GB unified memory, TSMC 3nm) ships fall 2026 in laptops/desktops from six major OEMs. INTC also closed -3%+. **Which means**: AMD's Ryzen AI PC bull leg gets compressed at the premium AI-PC tier; the structural read is that NVIDIA is now an end-to-end Windows AI-PC supplier, not just a discrete-GPU complement. Data-center thesis intact — Helios MI400/MI450 rack, OpenAI 6 GW, Meta 6 GW, Oracle 50K MI450 are all 2026-2027 stories that the Computex announcement doesn't touch. **Stance unchanged at bull/high** — AMD's primary 2026 catalyst is data-center, not PC. Watch trigger: any Lisa Su public response framing on whether AMD pursues an Arm-based PC SKU response or doubles down on Ryzen AI x86 differentiation.
