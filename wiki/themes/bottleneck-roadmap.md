...
| **2027** | **Cleanroom space (fabs)** | Memory makers + foundries didn't build new fabs through the 2023 trough; takes 2 years to build a fab | TSMC, Micron + foundry equipment ([[KLAC]], [[LRCX]], [[AMAT]], [[TER]]) + fab consumables ([[ENTG]]) + industrial gases ([[APD]] — multi-decade BOO contracts kick in 2028-2030) |
